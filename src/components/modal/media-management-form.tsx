...
export default function MediaManagementForm({ t, categories }: MediaManagementFormProps) {
  const {
    register,
    watch,
    trigger,
  ...
  const onSubmit = (data: MediaManagementValues) => {
    console.log(data); // TODO: Implement media management
    showMessage(t['Media has been added to your specified playlist.'], 'success');
    showMessage(t['Failed to add media to the specified playlist.'], 'error');
  };
        ...
        <div id='media-management-field-media-url' className='mb-4'>
          <Label
            ...
            className={cn(
              ...
              !!watch('youtubeUrl') && !errors.youtubeUrl && 'text-green-500 dark:text-green-400'
            )}
            touched={!!watch('youtubeUrl')}
            required
        ...
        <div id='media-management-field-media-files' className='mb-4'>
          <Label
            ...
            className={cn(
              ...
              !!watch('localPath') && !errors.localPath && 'text-green-500 dark:text-green-400'
            )}
            touched={!!watch('localPath')}
            required
        ...
        <div className='mb-4'>
          <Label
            ...
            className={cn(
              ...
              !!watch('category') && !errors.category && 'text-green-500 dark:text-green-400'
            )}
            touched={!!watch('category') && watch('category') !== t['Choose a playlist category']}
            required
          ...
          <select
            ...
            className={cn(
              ...
              !errors.category &&
                !!watch('category') &&
                watch('category') !== t['Choose a playlist category'] &&
                'bg-green-50 dark:bg-gray-700 border-green-500 dark:border-green-500 text-gray-900 dark:text-white placeholder-green-700 dark:placeholder-green-500 focus:ring-green-500 focus:border-green-500'
            )}
            required
        ...
        <div className='mb-4'>
          <Label
            ...
            className={cn(
              ...
              !!watch('mediaTitle') && !errors.mediaTitle && 'text-green-500 dark:text-green-400'
            )}
            touched={
              !!watch('mediaTitle') && watch('mediaTitle') !== t['Choose a playlist category']
            }
            required
        ...
        <div className='mb-4'>
          <Label
            ...
            className={cn(
              ...
              !!watch('artist') && !errors.artist && 'text-green-500 dark:text-green-400'
            )}
            t={t}
          >
            {t['Artist']}
        ...
        <div className='mb-4'>
          <Label
            ...
            className={cn(
              ...
              !!watch('description') && !errors.description && 'text-green-500 dark:text-green-400'
            )}
            t={t}
          >
            {t['Description']}
        ...
        <div className='mb-4'>
          <Label
            ...
            className={cn(
              ...
              !!watch('volume') && !errors.volume && 'text-green-500 dark:text-green-400'
            )}
            t={t}
          >
          ...
          <div>
            <Label
              ...
              className={cn(
                ...
                !!watch('seekStart') && !errors.seekStart && 'text-green-500 dark:text-green-400'
              )}
          ...
          <div>
            <Label
              ...
              className={cn(
                ...
                !!watch('seekEnd') && !errors.seekEnd && 'text-green-500 dark:text-green-400'
              )}
          ...
          <div>
            <Label
              ...
              className={cn(
                ...
                !!watch('fadeIn') && !errors.fadeIn && 'text-green-500 dark:text-green-400'
              )}
          ...
          <div>
            <Label
              ...
              className={cn(
                ...
                !!watch('fadeOut') && !errors.fadeOut && 'text-green-500 dark:text-green-400'
              )}
