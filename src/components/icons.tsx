...
export function Previous({ className, ...props }: IconProps) {
  return (
    <svg
      className={className}
      aria-label='previous'
...
export function Next({ className, ...props }: IconProps) {
  return (
    <svg
      className={className}
      aria-hidden='true'
...
export function Playlist({ className, ...props }: IconProps) {
  return (
    <svg
      className={className}
      aria-hidden='true'
...
export function Setting({ className, ...props }: IconProps) {
  return (
    <svg
      className={className}
      aria-hidden='true'
...
export function Options({ className, ...props }: IconProps) {
  return (
    <svg
      className={className}
      aria-hidden='true'
...
export function Alert({ className, ...props }: IconProps) {
  return (
    <svg
      className={className}
      aria-hidden='true'
