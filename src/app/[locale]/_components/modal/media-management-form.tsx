      ...
      {mediaType === "youtube" && (
        <div id="media-management-field-media-url" className="mb-4">
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
            {
              t[
                "Copy and paste full text of the YouTube video URL includes schema."
              ]
            }
          </p>
        </div>
      ...
      {mediaType === "local" && (
        <div id="media-management-field-media-files" className="mb-4">
          <Label
            ...
            required
            error={
              Boolean(errors.localPath?.message) ? t["Invalid file path"] : ""
            }
          >
            {t["Local Media File"]}
          </Label>
      ...
      <div id="media-management-field-meta" className="mb-4">
        <div className="mb-4">
          <Label
            ...
            required
            error={
              Boolean(errors.category?.message)
        ...
        <div className="mb-4">
          <Label
            ...
            touched={
              !!mediaTitle && mediaTitle !== t["Choose a playlist category"]
            }
            required
            error={
              Boolean(errors.mediaTitle?.message)
        ...
        <div className="grid gap-4 mb-4 md:grid-cols-2">
          <div>
            <Label
              ...
              error={
                Boolean(errors.seekStart?.message) ? t["Invalid format"] : ""
              }
            >
              {t["Seek start"]}
            </Label>
          ...
          <div>
            <Label
              ...
              error={
                Boolean(errors.seekEnd?.message) ? t["Invalid format"] : ""
              }
            >
              {t["Seek end"]}
            </Label>
        ...
        <div className="grid gap-4 mb-4 md:grid-cols-2">
          ...
          <div>
            <Label
              ...
              error={
                Boolean(errors.fadeOut?.message) ? t["Invalid format"] : ""
              }
            >
              {t["Fade-out seconds"]}
            </Label>
