...
const AccordionTitle = ({ children, ...props }: AccordionTitleProps) => (
  <FbAccordionTitle
    theme={
      theme("accordion", { title: { flush: { off: "focus:ring-0" } } }).title
    }
    {...props}
  >
    {children}
          ...
          <AccordionPanel>
            ...
            <AccordionContent>
              ...
              <p className="mt-4 mb-2 pt-4 text-sm text-gray-500 dark:text-gray-400 border-t border-gray-300 dark:border-gray-400">
                ...
                obtaining a copy <wbr />
                of this software and associated documentation files (the
                &quot;Software&quot;), to deal <wbr />
                in the Software without restriction, including without
                limitation the rights <wbr />
